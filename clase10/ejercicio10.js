...
let precioOriginal = parseFloat(prompt("Por favor ingrese el precio del producto deseado: ")); 
let porcentajeDescuento = parseFloat(prompt("Por favor ingrese el porcentaje de descuento a aplicar: ")); 
 
let montoDescuento = precioOriginal * (porcentajeDescuento /100); 
let precioFinal = precioOriginal - montoDescuento; 
console.log(`El precio final a pagar asciende a : ${precioFinal}`)
